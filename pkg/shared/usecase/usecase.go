...
import (
	...
	// @candi:usecaseImport
	webhookusecase "webhook-middleware/internal/modules/webhook/usecase"
...
type (
	...
	Usecase interface {
		// @candi:usecaseMethod
		Webhook() webhookusecase.WebhookUsecase
	}
...
func SetSharedUsecase(deps dependency.Dependency) {
	once.Do(func() {
		...
		// @candi:usecaseCommon
		usecaseInst.WebhookUsecase, setSharedUsecaseFunc = webhookusecase.NewWebhookUsecase(deps)
...
func (uc *usecaseUow) Webhook() webhookusecase.WebhookUsecase {
	return uc.WebhookUsecase
}
